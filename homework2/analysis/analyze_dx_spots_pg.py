#!/usr/bin/env python3
"""
Analyze DX cluster spots stored in the PostgreSQL database and print/save insights.

Usage:
  python analyze_dx_spots_pg.py [--plots] [--outdir DIR]
...
def load_tables():
    ...
    is available, otherwise return lists of dicts via psycopg2 cursor."""
...
def main():
    parser = argparse.ArgumentParser(description='Analyze DX cluster PostgreSQL database')
